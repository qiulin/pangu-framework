...
package org.pf9.pangu.framework.common.config;
 ...
 */
@Component
@ConfigurationProperties(prefix = "pangu", ignoreUnknownFields = false)
public class PanguProperties {
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String host = "192.168.1.117";

            private int port = 5432;

            private String prefix = "panguApplication";
    ...
    public static class Captcha {
        private boolean enabled = false;
        private List<String> securedUrls = Arrays.asList("/account/login");
