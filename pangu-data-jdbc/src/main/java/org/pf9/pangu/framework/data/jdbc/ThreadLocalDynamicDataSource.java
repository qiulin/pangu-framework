package org.pf9.pangu.framework.data.jdbc;
...
public class ThreadLocalDynamicDataSource extends AbstractDataSource implements InitializingBean {
    ...
    protected DataSource resolveSpecifiedDataSource(Object dataSource) throws IllegalArgumentException {
        if (dataSource instanceof DataSource) {
            ...
            throw new IllegalArgumentException("Illegal withData source value - only [javax.sql.DataSource] and String supported: " + dataSource);
        }
    }
